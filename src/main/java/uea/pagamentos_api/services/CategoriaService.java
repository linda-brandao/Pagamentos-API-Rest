...
public class CategoriaService {
	...
	public Categoria buscarPorCodigo(Long codigo) {
		Categoria categoria = categoriaRepository.findById(codigo).orElseThrow(); // se vier null a gente ja lança uma
	...
	public Categoria atualizar(Long codigo, Categoria categoria) {
		...
		BeanUtils.copyProperties(categoria, categoriaSalva, "codigo"); // atualizaçao em memoria
